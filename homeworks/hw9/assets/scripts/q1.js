...
let containterElement = document.getElementById("q1-container");

function setBackgroundColor(color) {
    // TODO: Get the element with the id "q1-container" and set its background color to the input color
    containterElement.style.backgroundColor = color;
}
...
let yellowButton = document.getElementById("q1-btn-yellow");
...
let lightblueButton = document.getElementById("q1-btn-lightblue");
