...
let secondlightboxID = "doggo2";
function unhideLightbox2() {
	unhideLightbox(secondlightboxID);
}
...
let thirdlightboxID = "doggo3";
function unhideLightbox3() {
	unhideLightbox(thirdlightboxID);
}
